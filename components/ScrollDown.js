...
export default function ScrollDown(props) {
    return (
        <>
            <div className="grid place-items-center fixed bottom-2 left-0 right-0 z-20 text-slate-400 font-bold animate-bounce select-none pointer-events-none" ref={props.compRef}>
