    ...
    return (
        <div className="flex mx-auto xl:flex-row md:flex-col h-screen pt-20">
            <section className="basis-1/2 p-20 grid place-content-center">
                <h1 className="text-4xl p-4 text-white font-bold">Culpa eiusmod elit ipsum commodo et ea quis nisi.</h1>
                <p className="p-4 text-slate-400">Cupidatat irure laborum ullamco proident occaecat veniam deserunt aliqua duis ea consectetur voluptate aliquip. Enim fugiat nisi occaecat excepteur velit nisi cillum minim. Aute pariatur duis anim aliquip dolore pariatur aliquip id esse qui commodo.</p>
            ...
            <section className="basis-1/2 grid grid-flow-col place-content-center">
                ...
                <Card className="z-10 scale-125" image={rb}></Card>
